...
namespace EscolaApi.Infra.Data.Migrations
{
    ...
    [Migration("20260925030831_CodigoRecuperacaoSenhaUsuario")]
    partial class CodigoRecuperacaoSenhaUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EscolaApi.Domain.Entities.CodigoRecuperacaoSenha", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<byte[]>("CodigoHash")
                        .IsRequired()
                        .HasColumnType("bytea");

                    b.Property<byte[]>("CodigoSalt")
                        .IsRequired()
                        .HasColumnType("bytea");
                    ...
                    b.ToTable("CodigoRecuperacaoSenha");
                });
            ...
            modelBuilder.Entity("EscolaApi.Domain.Entities.CodigoRecuperacaoSenha", b =>
                {
                    b.HasOne("EscolaApi.Domain.Entities.Usuario", "Usuario")
                        .WithMany()
